# HYDROFORCE PLUMBING OPERATIONS OS — Supabase 3-Minute Setup Guide

Welcome to **HydroForce Plumbing Operations OS** (Product #58) in the **Home Services & Commercial Contracting Vertical Vault**.

## Quick Start (3 Steps)

### 1. Create a Supabase Project
1. Log in to [Supabase](https://supabase.com).
2. Click **New Project** and name it `hydroforce-plumbing-os`.
...
- Route: `/admin`
- Passkey: `plumbing2026`
- Bypass: 1-click **[ HYDRAULIC PASS ]** button automatically injects credentials for instant client demo walkthroughs.
